...
SIMULATOR::SIMULATOR(int numActions, int numObservations, int numObjectives, double discount)
...
void SIMULATOR::DisplayVectorReward(std::vector<double> reward, std::ostream& ostr) const
{
	for (auto& rew: reward){
		ostr << rew << " ";
	}
